...
Then check that element "clientServicePortalTitle" is displayed
...
Scenario: Validating Quick Links on Home Page for Client
Given check that element "quickLinksTitle" is displayed
Then I click on the element: "chatWithAnAgent"
...
Scenario: Validating QuickLinks Title 
