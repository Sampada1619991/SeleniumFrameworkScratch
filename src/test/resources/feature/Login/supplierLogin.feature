...
Then fill the data for input filed:"username_aaa"from data table row:"Supplier Portal_Supplier User"
Then fill the data for input filed:"password_aaa"from data table row:"Supplier Portal_Supplier User"  
