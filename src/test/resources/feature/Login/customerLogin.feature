...
Then fill the data for input filed:"username_aaa"from data table row:"Client Portal_Client User"
Then fill the data for input filed:"password_aaa"from data table row:"Client Portal_Client User"  
